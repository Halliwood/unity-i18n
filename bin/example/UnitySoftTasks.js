...
utb.prefabTask.option.outputJSON = "Assets/AssetSources/i18n/$LANG.json";
utb.jsonTask.option.replaceOutput = "Assets/AssetSources/data$LANG/$FILENAME.json";
utb.jsonTask.option.outputJSON = "Assets/AssetSources/i18n/$LANG.json";
utb.tsTask.option.softReplacer = "I18N.I18NMgr.Translate($RAWSTRING)";
utb.tsTask.option.outputJSON = "Assets/AssetSources/i18n/$LANG.json";
utb.csTask.option.softReplacer = "I18N.I18NMgr.Translate($RAWSTRING)";
utb.csTask.option.outputJSON = "Assets/AssetSources/i18n/$LANG.json";
utb.svrCfgTask.option.outputJSON = "Assets/AssetSources/i18n/$LANG.json";
