...
(utb.prefabTask as TaskWithOption).option.outputJSONs = ["Assets/AssetSources/i18n/$LANG.json"];

(utb.jsonTask as TaskWithOption).option.replaceOutput = "Assets/AssetSources/data$LANG/$FILENAME.json";
(utb.jsonTask as TaskWithOption).option.outputJSONs = ["Assets/AssetSources/i18n/$LANG.json"];

(utb.tsTask as TaskWithOption).option.softReplacer = "I18N.I18NMgr.Translate($RAWSTRING)";
(utb.tsTask as TaskWithOption).option.outputJSONs = ["Assets/AssetSources/i18n/$LANG.json"];

(utb.csTask as TaskWithOption).option.softReplacer = "I18N.I18NMgr.Translate($RAWSTRING)";
(utb.csTask as TaskWithOption).option.outputJSONs = ["Assets/AssetSources/i18n/$LANG.json", "Assets/Resources/native$LANG.json"];

(utb.svrCfgTask as TaskWithOption).option.outputJSONs = ["Assets/AssetSources/i18n/$LANG.json"];
